...
@pytest.fixture
def tester():
    genesis_overrides = {"gas_limit": 8000000}
...
@pytest.fixture
def assert_validation_failed(tester):
    def assert_validation_failed(function_to_test, exception=ValidationError):
        with pytest.raises(exception):
            function_to_test()

    return assert_validation_failed
